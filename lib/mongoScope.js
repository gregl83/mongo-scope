...
/**
 * Transforms constructors into strings
 *
 * @function stringifyConstructor
 * @private
 * @sync
 * @param {function} src
 * @returns {string} str
 */
function stringifyConstructor (src) {
  return String(src); // todo build out more advanced constructor stringify
}
...
module.exports = function mongoScope (src) {
  ...
  fn.toString = function () {
    ...
    else if ('function' === typeof src) str += stringifyConstructor(src);
